 ...
 * 
 * Disassembly of SSDT-11x.aml, Mon Feb 23 00:04:25 2015
 *
 ...
 */
DefinitionBlock ("SSDT-11x.aml", "SSDT", 1, "PmRef", "Cpu0Cst", 0x00003001)
{
    ...
    Scope (\_PR.CPU0)
    {
        ...
        Method (_CST, 0, Serialized)  // _CST: C-States
        {
            ...
            Store ("C3ST Package", Debug)
            Store (C3ST, Debug)
            If (LAnd (AC2V, AC3V))
            {
                Store ("_CST All 3 C Ctates are supported ", Debug)
                Store (C3ST, Debug)
                Return (C3ST)
            }
            Else
            {
                If (AC2V)
                {
                    ...
                    Store ("_CST ACPI C1 and C2 are supported", Debug)
                    Store (C2ST, Debug)
                    Return (C2ST)
                }
                Else
                {
                    If (AC3V)
                    {
                        ...
                        Store ("_CST ACPI C1 and C2(HW C3 Converted to C2) are supported", Debug)
                        Store (C2ST, Debug)
                        Return (C2ST)
                    }
                    Else
                    {
                        ...
                        Store ("_CST Only C1 Supported", Debug)
                        Store (C1ST, Debug)
                        Return (C1ST)
                    }
                }
