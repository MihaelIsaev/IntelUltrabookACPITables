 ...
 * 
 * Disassembly of SSDT-1.aml, Mon Feb 23 00:04:25 2015
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00005D2E (23854)
 *     Revision         0x01
 *     Checksum         0xCE
 *     OEM ID           "DptfFf"
 *     OEM Table ID     "DptfFfrd"
 *     OEM Revision     0x00001000 (4096)
 *     Compiler ID      "INTL"
 *     Compiler Version 0x20120913 (538052883)
 */
DefinitionBlock ("SSDT-1.aml", "SSDT", 1, "DptfFf", "DptfFfrd", 0x00001000)
{
    ...
    External (_SB_.PCI0.LPCB.H_EC.AMBT, FieldUnitObj)
    ...
    External (_SB_.PCI0.LPCB.H_EC.CFS2, FieldUnitObj)
    External (_SB_.PCI0.LPCB.H_EC.CFSP, FieldUnitObj)
    External (_SB_.PCI0.LPCB.H_EC.DIM0, FieldUnitObj)
    External (_SB_.PCI0.LPCB.H_EC.DIM1, FieldUnitObj)
    ...
    External (_SB_.PCI0.LPCB.H_EC.FANT, FieldUnitObj)
    ...
    External (_SB_.PCI0.LPCB.H_EC.SKNT, FieldUnitObj)
    ...
    External (IFAT, FieldUnitObj)
    External (IFCT, FieldUnitObj)
    External (IFHT, FieldUnitObj)
    External (IFPT, FieldUnitObj)
    External (INLD, FieldUnitObj)
    ...
    Scope (\_SB)
    {
        Device (IETM)
        {
            ...
            Method (PRNT, 0, NotSerialized)
            {
                Name (TEMP, Zero)
                ADBG ("Method PRNT")
                Store (DerefOf (Index (TMPP, Zero)), TEMP)
                ADBG (TEMP)
                Store (DerefOf (Index (TMPP, One)), TEMP)
                ADBG (TEMP)
                Store (DerefOf (Index (TMPP, 0x02)), TEMP)
                ADBG (TEMP)
                Store (DerefOf (Index (TMPP, 0x03)), TEMP)
                ADBG (TEMP)
                Store (DerefOf (Index (TMPP, 0x04)), TEMP)
                ADBG (TEMP)
                Store (DerefOf (Index (TMPP, 0x05)), TEMP)
                ADBG (TEMP)
            }
    ...
    Scope (\_SB.PCI0)
    {
        Device (B0D4)
        {
            ...
            Method (PRNP, 0, NotSerialized)
            {
                Name (TEMP, 0x80000000)
                ADBG ("Method PRNP")
                Store (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, Zero)), TEMP)
                ADBG (TEMP)
                Store (DerefOf (Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, One)), Zero)), 
                    TEMP)
                ADBG (TEMP)
                Store (DerefOf (Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, One)), One)), 
                    TEMP)
                ADBG (TEMP)
                Store (DerefOf (Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, One)), 0x02)), 
                    TEMP)
                ADBG (TEMP)
                Store (DerefOf (Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, One)), 0x03)), 
                    TEMP)
                ADBG (TEMP)
                Store (DerefOf (Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, One)), 0x04)), 
                    TEMP)
                ADBG (TEMP)
                Store (DerefOf (Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, One)), 0x05)), 
                    TEMP)
                ADBG (TEMP)
                Store (DerefOf (Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, 0x02)), Zero)), 
                    TEMP)
                ADBG (TEMP)
                Store (DerefOf (Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, 0x02)), One)), 
                    TEMP)
                ADBG (TEMP)
                Store (DerefOf (Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, 0x02)), 0x02)), 
                    TEMP)
                ADBG (TEMP)
                Store (DerefOf (Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, 0x02)), 0x03)), 
                    TEMP)
                ADBG (TEMP)
                Store (DerefOf (Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, 0x02)), 0x04)), 
                    TEMP)
                ADBG (TEMP)
                Store (DerefOf (Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, 0x02)), 0x05)), 
                    TEMP)
                ADBG (TEMP)
            }
    ...
    Scope (\_SB.PCI0.LPCB.H_EC)
    {
        Device (TAMB)
        {
            ...
            Name (HITP, 0x64)
            Name (AAUX, 0x10)
            Name (_STR, Unicode ("WWAN Board Temperature Sensor"))  // _STR: Description String
            Name (PTYP, 0x03)
            Method (SDBG, 0, NotSerialized)
            {
                If (LEqual (SDEB, One))
    ...
    Scope (\_SB.PCI0.LPCB.H_EC)
    {
        Device (TEFN)
        {
            ...
            Name (HITP, 0x64)
            Name (EAUX, 0x10)
            Name (_STR, Unicode ("SSD Board Temperature Sensor"))  // _STR: Description String
            Name (PTYP, 0x03)
            Method (SDBG, 0, NotSerialized)
            {
                If (LEqual (SDEB, One))
    ...
    Scope (\_SB.PCI0.LPCB.H_EC)
    {
        Device (TFN1)
        {
            ...
            Name (_STR, Unicode ("CPU Fan #1"))  // _STR: Description String
            Name (FON, One)
            Method (SDBG, 0, NotSerialized)
            {
                If (LEqual (SDEB, One))
            ...
            Method (_FSL, 1, Serialized)  // _FSL: Fan Set Level
            {
                If (\ECON)
                {
                    ...
                    Store (Arg0, Index (\_TZ.FAN0._FST, One))
    ...
    Scope (\_SB.PCI0.LPCB.H_EC)
    {
        Device (TFN2)
        {
            Name (_HID, EisaId ("INT3404"))  // _HID: Hardware ID
            Name (_UID, One)  // _UID: Unique ID
            Name (_STR, Unicode ("CPU Fan #2"))  // _STR: Description String
            Method (SDBG, 0, NotSerialized)
            {
                If (LEqual (SDEB, One))
                {
            ...
            {
                Store (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PENV)), Index (TFST, One))
                Store (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.CFS2)), Index (TFST, 0x02))
                Return (TFST)
            }
        }
    }
            ...
            Method (TMPX, 0, NotSerialized)
            {
                If (\ECON)
                {
                    If (\TSOD)
                    {
                        ...
                        {
                            Store (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSD0)), Local1)
                        }
                        Else
                        {
                            Store (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSD1)), Local1)
                        }
                    }
                    Else
                    {
                        Store (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.DIM0)), Local1)
                    }
    ...
    Scope (\_SB.PCI0.LPCB.H_EC)
    {
        Device (TSKN)
        {
            ...
            Name (HITP, 0x64)
            Name (SAUX, 0x10)
            Name (_STR, Unicode ("CPU VR Board Temperature Sensor"))  // _STR: Description String
            Name (PTYP, 0x03)
            Method (SDBG, 0, NotSerialized)
            {
                If (LEqual (SDEB, One))
    ...
    Scope (\_SB.PCI0.LPCB.H_EC.TSKN)
    {
        ...
        Method (_AC1, 0, NotSerialized)  // _ACx: Active Cooling
        {
            Store (\_SB.IETM.CTOK (SKAT), Local0)
            Subtract (Local0, AC1D, Local1)
            If (LGreaterEqual (LSTM, Local1))
            {
                Subtract (AHYS, GTSH, Local2)
    ...
    Scope (\_SB.PCI0.LPCB.H_EC)
    {
        Device (TINL)
        {
            ...
            Name (HITP, 0x64)
            Name (SAUX, 0x10)
            Name (_STR, Unicode ("Board Fan Inlet Temperature Sensor"))  // _STR: Description String
            Name (PTYP, 0x03)
            Method (SDBG, 0, NotSerialized)
            {
                If (LEqual (SDEB, One))
            ...
            Method (_TMP, 0, NotSerialized)  // _TMP: Temperature
            {
                If (\ECON)
                {
                    Store (\_SB.PCI0.LPCB.H_EC.DIM1, Local1)
                    Return (\_SB.IETM.CTOK (Local1))
                }
                Else
                {
            ...
            Method (PAT0, 1, Serialized)
            {
                If (\ECON)
                {
                    ...
                    {
                        Store (\_SB.IETM.KTOC (Arg0), SAUX)
                        \_SB.PCI0.LPCB.H_EC.ECWT (0x05, RefOf (\_SB.PCI0.LPCB.H_EC.TSI))
                        \_SB.PCI0.LPCB.H_EC.ECWT (0x02, RefOf (\_SB.PCI0.LPCB.H_EC.HYST))
                        \_SB.PCI0.LPCB.H_EC.ECWT (SAUX, RefOf (\_SB.PCI0.LPCB.H_EC.TSLT))
                        \_SB.PCI0.LPCB.H_EC.ECMD (0x4A)
                        Release (\_SB.PCI0.LPCB.H_EC.PATM)
    ...
    Scope (\_SB.PCI0.LPCB.H_EC.TINL)
    {
        ...
        Method (_AC0, 0, NotSerialized)  // _ACx: Active Cooling
        {
            If (CTYP)
            {
                Store (\_SB.IETM.CTOK (IFPT), Local1)
            }
            Else
            {
                Store (\_SB.IETM.CTOK (IFAT), Local1)
            }
        ...
        Method (_PSV, 0, Serialized)  // _PSV: Passive Temperature
        {
            If (CTYP)
            {
                Return (\_SB.IETM.CTOK (IFAT))
            }
            Else
            {
                Return (\_SB.IETM.CTOK (IFPT))
            }
        }
    }
    ...
    Scope (\_SB.PCI0.LPCB.H_EC)
    {
        Device (GEN1)
        {
            ...
            Name (HITP, 0x64)
            Name (AAUX, 0x10)
            Name (_STR, Unicode ("Harris Beach Thermistor 1 participant"))  // _STR: Description String
            Name (PTYP, 0x03)
            Method (SDBG, 0, NotSerialized)
            {
                If (LEqual (SDEB, One))
            ...
            Method (_TMP, 0, Serialized)  // _TMP: Temperature
            {
                ...
                {
                    Return (ShiftLeft (\_SB.PCI0.LPCB.H_EC.TER1, 0x02))
                }
                Else
                {
                    Return (0x0BB8)
    ...
    Scope (\_SB.PCI0.LPCB.H_EC)
    {
        Device (GEN2)
        {
            ...
            Name (HITP, 0x64)
            Name (AAUX, 0x10)
            Name (_STR, Unicode ("Harris Beach Thermistor 2 participant"))  // _STR: Description String
            Name (PTYP, 0x03)
            Method (SDBG, 0, NotSerialized)
            {
                If (LEqual (SDEB, One))
            ...
            Method (_TMP, 0, Serialized)  // _TMP: Temperature
            {
                If (LEqual (\_SB.PCI0.LPCB.H_EC.ECAV, One))
                {
                    Return (\_SB.IETM.CTOK (\_SB.PCI0.LPCB.H_EC.TER2))
                }
                Else
                {
                    Return (0x0BB8)
