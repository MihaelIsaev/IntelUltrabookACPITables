 ...
 * 
 * Disassembly of SSDT-13.aml, Mon Feb 23 00:04:25 2015
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x0000342C (13356)
 *     Revision         0x01
 *     Checksum         0x2C
 *     OEM ID           "SaSsdt"
 *     OEM Table ID     "SaSsdt "
 ...
 */
DefinitionBlock ("SSDT-13.aml", "SSDT", 1, "SaSsdt", "SaSsdt ", 0x00003000)
{
    /*
    ...
    External (_SB_.PCI0.IGPU.SDSM, IntObj)
    ...
    OperationRegion (SANV, SystemMemory, 0x5EF9AC98, 0x01F4)
    ...
    Scope (\_SB.PCI0)
    {
        ...
        Device (IGPU)
        {
            ...
            Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
            {
                If (CondRefOf (\_SB.PCI0.GFX0.SDSM))
                {
                    Return (\_SB.PCI0.GFX0.SDSM)
                    Arg0
                    Arg1
                    Arg2
                    Arg3
