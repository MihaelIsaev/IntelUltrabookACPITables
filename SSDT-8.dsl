 ...
 * 
 * Disassembly of SSDT-8.aml, Mon Feb 23 00:04:25 2015
 *
 ...
 */
DefinitionBlock ("SSDT-8.aml", "SSDT", 1, "PmRef", "Cpu0Ist", 0x00003000)
{

    External (_PR_.CFGD, FieldUnitObj)
    External (_PR_.CPPC, FieldUnitObj)
    External (_PR_.CPU0, ProcessorObj)
    External (_PR_.MPMF, FieldUnitObj)
        ...
        Method (_PSD, 0, NotSerialized)  // _PSD: Power State Dependencies
        {
            If (LNot (PSDF))
            {
                ...
                If (And (MPMF, 0x02))
                {
                    ...
                    Store (One, Index (DerefOf (Index (SPSD, Zero)), 0x04))
                    Store (Zero, Index (DerefOf (Index (HPSD, Zero)), 0x02))
                    Store (Zero, Index (DerefOf (Index (SPSD, Zero)), 0x02))
                }
